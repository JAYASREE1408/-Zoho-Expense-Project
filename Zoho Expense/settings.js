...
function post_currency() {
    ...
    fetch(url, {
        ...
        .then(data => {
            ...
            document.getElementById('currency_status').innerHTML = "Success";
            load_datas();
...
function post_merchant() {
    ...
    fetch(url, {
        ...
        .then(data => {
            ...
            document.getElementById('merchant_status').innerHTML = "Success";
            load_datas();
...
function post_category() {
    ...
    fetch(url, {
        ...
        .then(data => {
            ...
            document.getElementById('category_status').innerHTML = "Success";
            load_datas();
