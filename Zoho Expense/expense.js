        ...
        .then(data => {
            ...
            if (data.status == "success") {
                ...
                for (count in data.data) {
                   ...
                   <br>Merchant  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  :<input type="text" value="${data.data[count].customer}" id="customer${data.data[count].id}" readOnly><br><br>
                    Currency    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     : <input type="text" value="${data.data[count].currency}" id="currency${data.data[count].id}" readOnly ><br>
                   
                   <br>Refno   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;      : <input type="text" value="${data.data[count].refno}" id="refno${data.data[count].id}" readOnly><br>
                   <br>Total Amount &nbsp;: <input type="text" value="${data.data[count].symbol}  ${data.data[count].total}" id="total${data.data[count].id}" readOnly><br></p></h4>
